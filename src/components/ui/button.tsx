  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-gradient-secondary text-secondary-foreground hover:shadow-elegant hover:scale-105 transition-all duration-300",
        success:
          "bg-gradient-success text-success-foreground hover:shadow-glow hover:scale-105 transition-all duration-300",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-hero text-white border-2 border-white/20 hover:border-white/40 hover:shadow-glow hover:scale-105 transition-all duration-300",
      },
      size: {
